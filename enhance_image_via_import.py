...
ADD_COMPARISONS = True  # Set to False to turn off comparison images

UTILITIES_DIRECTORY = 'utilities_needed'
LANDMARKS_MODEL_PATH = os.path.join(UTILITIES_DIRECTORY, 'shape_predictor_68_face_landmarks.dat')
...
def enhance_image(input_image_path, output_dir):
    if not os.path.exists(LANDMARKS_MODEL_PATH):
        print(f"{LANDMARKS_MODEL_PATH} not found. Downloading from {LANDMARKS_MODEL_URL}...")
